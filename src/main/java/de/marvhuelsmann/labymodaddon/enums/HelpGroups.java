...
public enum HelpGroups {
    ...
    HELPER("HELPER", EnumChatFormatting.WHITE + "LabyHelp" + EnumChatFormatting.BLUE + " HELPER", true, true, true),
    DESIGNER("DESIGNER", EnumChatFormatting.WHITE + "LabyHelp" + EnumChatFormatting.AQUA + " DESIGNER", true, true, true),
