...
public class InviteManager {
    ...
    public UUID getFamousInvitePlayer() {
        ...
        if (!userInvites.isEmpty()) {
            for (Map.Entry<UUID, String> uuidStringEntry : LabyHelp.getInstace().getLikeManager().userLikes.entrySet()) {
                int i = Integer.parseInt(LabyHelp.getInstace().getLikeManager().userLikes.get(uuidStringEntry.getKey()));
